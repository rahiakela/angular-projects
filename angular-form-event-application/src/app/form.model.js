...
class ProductFormGroup extends forms_1.FormGroup {
    constructor() {
        super({
            ...
            price: new ProductFormControl('Price', 'price', '', forms_1.Validators.compose([forms_1.Validators.required, limit_formvalidator_1.LimitValidator.Limit(100), forms_1.Validators.pattern('^[0-9\.]+$')]))
        });
    }
    get productControls() {
