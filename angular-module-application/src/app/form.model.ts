...
import {LimitValidator} from './model/limit.formvalidator';
...
export class ProductFormGroup extends FormGroup {
    constructor() {
        super({
            name: new ProductFormControl('Name', 'name', '', Validators.compose([Validators.pattern('^[A-Za-z ]+$'), Validators.minLength(5), Validators.maxLength(15)])),
            category: new ProductFormControl('Category', 'category', '', Validators.compose([Validators.pattern('^[A-Za-z ]+$'), Validators.minLength(3), Validators.maxLength(10)])),
            price: new ProductFormControl('Price', 'price', '', Validators.compose([Validators.required, LimitValidator.Limit(2000), Validators.pattern('^[0-9\.]+$')]))
        });
    }
